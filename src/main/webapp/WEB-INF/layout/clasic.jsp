		...
		<div class="row">
			<div class="col-md-3">
				<div class="list-group">
					...
					<a href="#" class="list-group-item active">Setting</a>
					<div class="list-group-item">
						<a href='<spring:url value="/register.html"></spring:url>'>User Registration</a>
					</div>
					<div class="list-group-item">
						<a href='<spring:url value="/departement.html"></spring:url>'>Departement</a>
					</div>
					<div class="list-group-item">
